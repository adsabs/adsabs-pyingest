...
# Abstract
                try:
                    ...
                    print "problem with output_metadata['abstract']"
                    pass
                else:
                    if type(output_metadata['abstract']) == basestring:
                        print "LOL ABSTRACT",type(output_metadata['abstract'])
                    else:
                        output_metadata['abstract'] = output_metadata['abstract']['#text']
...
# Data passed to output_metadata with Authors
                ...
                try:
                    ...
                    affils[notes_meta['fn']['@id']] = notes_meta['fn']['p']
                except:
                    print "something's borked with affil notes..."
                    pass
                print affils.keys()
