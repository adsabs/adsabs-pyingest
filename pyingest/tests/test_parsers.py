...
class TestIOP(unittest.TestCase):
    ...
    def test_iop_parser(self):
        ...
        with open(test_infile) as fp:
            ...
            output_pub = u'The Astrophysical Journal, Volume 882, Issue 2, id.74, 13 pp.'
